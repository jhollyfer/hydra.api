...
var Address = import_zod.default.object({
  ...
  neighborhood: import_zod.default.string().trim(),
  complement: import_zod.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
  street: import_zod.default.string().trim()
});
...
var CreateMemberSchema = import_zod.default.object({
  name: import_zod.default.string().trim(),
  cpf: import_zod.default.string().trim(),
  rg: import_zod.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
