...
// app/controllers/administrator/members/create.controller.ts
...
// app/use-case/administrator/members/create.use-case.ts
...
CreateUseCase = __decorateClass([
  (0, import_fastify_decorators.Service)()
], CreateUseCase);

// app/validators/administrator/members/create.ts
...
var CreateMemberSchema = import_zod2.default.object({
...
var create_default = CreateMemberSchema;

// app/controllers/administrator/members/create.controller.ts
var import_fastify_decorators2 = require("fastify-decorators");
var CreateController = class {
  constructor(useCase = (0, import_fastify_decorators2.getInstanceByToken)(CreateUseCase)) {
    this.useCase = useCase;
  }
  async handle(request, response) {
    const payload = create_default.parse(request.body);
...
], CreateController.prototype, "handle", 1);
CreateController = __decorateClass([
