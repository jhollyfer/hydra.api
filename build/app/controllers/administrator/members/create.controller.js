  ...
  "generated/prisma/index.js"(exports2) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/indio/Documents/hydra/new-api/generated/prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "sourceFilePath": "/home/indio/Documents/hydra/new-api/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
      ...
      "inlineSchemaHash": "8e4b52ac8c0e0f48b668b70682f94d3d2f35888279a13bcb07ddebd90ae4d496",
      "copyEngine": true
    };
    var fs = require("fs");
...
var Address = import_zod2.default.object({
  ...
  neighborhood: import_zod2.default.string().trim(),
  complement: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
  street: import_zod2.default.string().trim()
});
...
var CreateMemberSchema = import_zod2.default.object({
  ...
  cpf: import_zod2.default.string().trim(),
  rg: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
