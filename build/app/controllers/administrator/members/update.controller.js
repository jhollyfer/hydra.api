...
var require_library = __commonJS({
  "generated/prisma/runtime/library.js"(exports2, module2) {
    ...
    var ko = (e, r, t, n) => {
      if (r && typeof r == "object" || typeof r == "function") for (let i of vu(r)) !Su.call(e, i) && i !== t && Vt(e, i, { get: () => r[i], enumerable: !(n = Pu(r, i)) || n.enumerable });
      return e;
    };
...
${c}`);
    ...
    var Zt = {};
    tr(Zt, { beep: () => Fc, clearScreen: () => kc, clearTerminal: () => _c, cursorBackward: () => yc, cursorDown: () => gc, cursorForward: () => hc, cursorGetPosition: () => wc, cursorHide: () => vc, cursorLeft: () => ns, cursorMove: () => fc, cursorNextLine: () => xc, cursorPrevLine: () => Pc, cursorRestorePosition: () => Ec, cursorSavePosition: () => bc, cursorShow: () => Tc, cursorTo: () => mc, cursorUp: () => ts, enterAlternativeScreen: () => Nc, eraseDown: () => Cc, eraseEndLine: () => Rc, eraseLine: () => is, eraseLines: () => Sc, eraseScreen: () => gi, eraseStartLine: () => Ac, eraseUp: () => Ic, exitAlternativeScreen: () => Lc, iTerm: () => qc, image: () => $c, link: () => Mc, scrollDown: () => Oc, scrollUp: () => Dc });
    var zt = A(require("process"), 1);
    var Yt = globalThis.window?.document !== void 0;
    ...
    var Pg = globalThis.process?.versions?.electron !== void 0;
    var vg = globalThis.navigator?.userAgent?.includes("jsdom") === true;
...
Details: ${r.message}`;
    ...
    var on = `${Es}:`;
    function sn(e) {
      return e?.toString().startsWith(`${on}//`) ?? false;
    }
    function Ii(e) {
...
`);
    ...
    var tt = {};
    tr(tt, { error: () => np, info: () => tp, log: () => rp, query: () => ip, should: () => Ps, tags: () => rt, warn: () => _i });
    ...
    function ot({ rootEnvPath: e, schemaEnvPath: r }, t = { conflictCheck: "none" }) {
      ...
      let i = null;
      return Ns(n?.path, r) || (i = _s(r)), !n && !i && $i("No Environment variables loaded"), i?.dotenvResult.error ? console.error(ce(W("Schema Env Error: ")) + i.dotenvResult.error) : { message: [n?.message, i?.message].filter(Boolean).join(`
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    x(z4, "PrismaClientKnownRequestError");
    ...
    m.hyperbolicCosine = m.cosh = function() {
      ...
      t = s.precision, n = s.rounding, s.precision = t + Math.max(o.e, o.sd()) + 4, s.rounding = 1, i = o.d.length, i < 32 ? (e = Math.ceil(i / 3), r = (1 / wn(4, e)).toString()) : (e = 16, r = "2.3283064365386962890625e-10"), o = vr(s, 1, o.times(r), new s(1), true);
    ...
    m.hyperbolicSine = m.sinh = function() {
      ...
      if (r = o.precision, t = o.rounding, o.precision = r + Math.max(i.e, i.sd()) + 4, o.rounding = 1, n = i.d.length, n < 3) i = vr(o, 2, i, i, true);
      else {
        e = 1.4 * Math.sqrt(n), e = e > 16 ? 16 : e | 0, i = i.times(1 / wn(5, e)), i = vr(o, 2, i, i, true);
    ...
    m.toExponential = function(e, r) {
      var t, n = this, i = n.constructor;
      return e === void 0 ? t = Pe(n, true) : (ie(e, 0, Ye), r === void 0 ? r = i.rounding : ie(r, 0, 8), n = y(new i(n), e + 1, r), t = Pe(n, true, e + 1)), n.isNeg() && !n.isZero() ? "-" + t : t;
    };
    m.toFixed = function(e, r) {
      var t, n, i = this, o = i.constructor;
      return e === void 0 ? t = Pe(i) : (ie(e, 0, Ye), r === void 0 ? r = o.rounding : ie(r, 0, 8), n = y(new o(i), e + i.e + 1, r), t = Pe(n, false, e + n.e + 1)), i.isNeg() && !i.isZero() ? "-" + t : t;
    };
    ...
    var xn = {};
    var yd = 0;
    var P = { manual: xn.Prism && xn.Prism.manual, disableWorkerMessageHandler: xn.Prism && xn.Prism.disableWorkerMessageHandler, util: { encode: function(e) {
      if (e instanceof ge) {
        let r = e;
      ...
      for (let g in t) {
        ...
        for (let T = 0; T < D.length; ++T) {
          ...
          for (let j = n, te = i; j < r.length; te += r[j].length, ++j) {
            ...
            if (K.push(fr), h && K.push(h), Array.prototype.splice.apply(r, K), u != 1 && P.matchGrammar(e, r, t, j, te, true, g), o) break;
          }
        }
      }
...
`);
    ...
    function vd({ callsite: e, message: r, originalMethod: t, isPanic: n, callArguments: i }, o) {
      let s = Pd({ message: r, originalMethod: t, isPanic: n, callArguments: i });
...
`);
    ...
    function _n({ args: e, errors: r, errorFormat: t, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
      ...
      let { message: l, args: u } = kn(a, t), c = vn({ message: l, callsite: n, originalMethod: i, showColors: t === "pretty", callArguments: u });
    ...
    function he(e, r) {
      let t = pm(r), n = /* @__PURE__ */ new Set(), i = new Proxy(e, { get(o, s) {
        ...
        let l = t.get(s);
        return l ? l.getPropertyDescriptor ? { ...Vn, ...l?.getPropertyDescriptor(s) } : Vn : a;
    ...
    function Mr({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z4(mm(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new V(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function mm(e, r) {
      let t = e.message;
...
`);
    ...
    function vt(e) {
      ...
      if (typeof e == "object") {
        let r = {};
        for (let t in e) t === "__proto__" ? Object.defineProperty(r, t, { value: vt(e[t]), configurable: true, enumerable: true, writable: true }) : r[t] = vt(e[t]);
        return r;
      }
      ar(e, "Unknown value");
    }
...
Learn how: https://pris.ly/d/${ul[r]}-build`;
    ...
    var Jm = () => globalThis.process?.release?.name === "node";
    ...
    var Zm = () => globalThis.navigator?.userAgent === "Cloudflare-Workers";
    function Xm() {
...
${er(e)}`;
    ...
    async function yl(e, r) {
      ...
      let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d) => d.native), l = !s.some((d) => d.value === o), u = __filename.match(nf()) === null, c = { searchedLocations: i, generatorBinaryTargets: s, generator: r.generator, runtimeBinaryTarget: o, queryEngineName: bl(e, o), expectedLocation: Tt.default.relative(process.cwd(), r.dirname), errorStack: new Error().stack }, p;
      throw a && l ? p = fl(c) : l ? p = dl(c) : u ? p = ml(c) : p = gl(c), new v(p, r.clientVersion);
    }
    async function of(e, r) {
      let t = await ir(), n = [], i = [r.dirname, Tt.default.resolve(__dirname, ".."), r.generator?.output?.value ?? __dirname, Tt.default.resolve(__dirname, "../../../.prisma/client"), "/tmp/prisma-engines", r.cwd];
...
`;
    ...
    async function Lt(e, r) {
      ...
      if (n.type === "QueryEngineError") throw new z4(n.body.message, { code: n.body.error_code, clientVersion: r });
    ...
    var Ol = { "@prisma/debug": "workspace:*", "@prisma/engines-version": "6.14.0-25.717184b7b35ea05dfa71a3236b7af656013e1e49", "@prisma/fetch-engine": "workspace:*", "@prisma/get-platform": "workspace:*" };
    ...
    var Gr = class {
      ...
      async transaction(r, t, n) {
        ...
        if (Sf(a)) {
          ...
          throw l ? l.error : new z4(a.message, { code: a.error_code, clientVersion: this.config.clientVersion, meta: a.meta });
      ...
      async start() {
        ...
        let r = async () => {
          ...
          try {
            ...
            await this.engine?.connect(JSON.stringify(t)), this.libraryStarted = true, this.adapterPromise || (this.adapterPromise = this.config.adapter?.connect()?.then(rn)), await this.adapterPromise, Re("library started");
          } catch (t) {
...
${a.backtrace}`, { clientVersion: this.config.clientVersion });
      ...
      async requestBatch(r, { transaction: t, traceparent: n }) {
        ...
        this.lastQuery = JSON.stringify(i), this.executingQueryPromise = this.engine?.query(this.lastQuery, JSON.stringify({ traceparent: n }), Ll(t));
...
`);
    ...
    var Ro = ({ clientMethod: e, activeProvider: r }) => (t) => {
      ...
      return i?.values ? Kl(`prisma.${e}(${n}, ${i.values})`) : Kl(`prisma.${e}(${n})`), { query: n, parameters: i };
    };
    ...
    var ei = class {
      ...
      constructor(r, t) {
        this.logEmitter = t, this.client = r, this.dataloader = new Zn({ batchLoader: ol(async ({ requests: n, customDataProxyFetch: i }) => {
          ...
          let i = n.transaction?.kind === "itx" ? nu(n.transaction) : void 0, o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: Do(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
          return this.mapQueryEngineResult(n, o);
        }, batchBy: (n) => n.transaction?.id ? `transaction-${n.transaction.id}` : ru(n.protocolQuery), batchOrder(n, i) {
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (l = vn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
          ...
          throw new z4(l, { code: r.code, clientVersion: this.client._clientVersion, meta: u, batchRequestIdx: r.batchRequestIdx });
        } else {
...
${n}`;
    ...
    function bu(e) {
      class r {
        ...
        _createItxClient(n) {
          return he(Pt(he(Ha(this), [re("_appliedParent", () => this._appliedParent._createItxClient(n)), re("_createPrismaPromise", () => Ao(n)), re(jf, () => n.id)])), [Lr(el)]);
        }
        $transaction(n, i) {
          let o;
...
var require_prisma = __commonJS({
  "generated/prisma/index.js"(exports2) {
    ...
    exports2.Prisma.MemberScalarFieldEnum = {
      id: "id",
      cpf: "cpf",
      rg: "rg",
      birthDate: "birthDate",
    ...
    exports2.Prisma.ResponsibleScalarFieldEnum = {
      id: "id",
      mother: "mother",
      father: "father",
      userId: "userId",
    ...
    exports2.UserRoleEnum = exports2.$Enums.UserRoleEnum = {
      FOUNDER: "FOUNDER",
      SPONSOR: "SPONSOR",
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/indio/Documents/hydra/api/generated/prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "sourceFilePath": "/home/indio/Documents/hydra/api/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    config.runtimeDataModel = JSON.parse('{"models":{"User":{"dbName":"users","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"email","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"password","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"member","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Member","nativeType":null,"relationName":"member","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"role","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"UserRoleEnum","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"address","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Address","nativeType":null,"relationName":"address","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"responsible","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Responsible","nativeType":null,"relationName":"responsibles","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Member":{"dbName":"members","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"cpf","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"rg","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"birthDate","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"extras","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"member","relationFromFields":["userId"],"relationToFields":["id"],"relationOnDelete":"Cascade","isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Address":{"dbName":"addresses","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"street","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"number","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"complement","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"neighborhood","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"address","relationFromFields":["userId"],"relationToFields":["id"],"relationOnDelete":"Cascade","isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Responsible":{"dbName":"responsibles","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"mother","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"father","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"responsibles","relationFromFields":["userId"],"relationToFields":["id"],"relationOnDelete":"Cascade","isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{"UserRoleEnum":{"values":[{"name":"FOUNDER","dbName":null},{"name":"SPONSOR","dbName":null},{"name":"PARTICIPANT","dbName":null},{"name":"COLLABORATOR","dbName":null},{"name":"ADMINISTRATOR","dbName":null}],"dbName":null}},"types":{}}');
...
// app/controllers/administrator/members/update.controller.ts
var update_controller_exports = {};
__export(update_controller_exports, {
  default: () => UpdateController
});
module.exports = __toCommonJS(update_controller_exports);
...
var Address = import_zod2.default.object({
  number: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
  neighborhood: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
  complement: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
  street: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  })
});
var Responsible = import_zod2.default.object({
  mother: import_zod2.default.string().trim(),
  father: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  })
});
var UpdateMemberSchema = import_zod2.default.object({
  name: import_zod2.default.string().trim(),
  cpf: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
  rg: import_zod2.default.string().trim(),
  birthDate: import_zod2.default.string().trim(),
  extras: import_zod2.default.string().trim().nullable().transform((value) => {
    if (!value) return null;
    return value;
  }),
  role: import_zod2.default.enum(Object.values(import_prisma2.UserRoleEnum)),
...
var UpdateController = class {
  constructor(useCase = (0, import_fastify_decorators2.getInstanceByToken)(UpdateUseCase)) {
    this.useCase = useCase;
  }
  async handle(request, response) {
    const schema2 = import_zod3.default.object({
      id: import_zod3.default.string().trim()
    });
    const params = schema2.parse(request.params);
    const payload = update_default.parse(request.body);
...
__decorateClass([
  (0, import_fastify_decorators2.PATCH)({
    url: "/:id",
    options: {
      onRequest: [AuthenticationMiddleware]
    }
  })
], UpdateController.prototype, "handle", 1);
UpdateController = __decorateClass([
