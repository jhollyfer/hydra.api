...
// app/controllers/administrator/members/get-by-id.controller.ts
var get_by_id_controller_exports = {};
__export(get_by_id_controller_exports, {
  default: () => GetByIdController
});
module.exports = __toCommonJS(get_by_id_controller_exports);
...
// app/use-case/administrator/members/get-by-id.use-case.ts
...
GetByIdUseCase = __decorateClass([
...
var GetByIdController = class {
  ...
  async handle(request, response) {
    const schema2 = import_zod2.default.object({
      id: import_zod2.default.string().trim()
    });
    const payload = schema2.parse(request.params);
...
], GetByIdController.prototype, "handle", 1);
GetByIdController = __decorateClass([
