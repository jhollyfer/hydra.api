...
// app/controllers/administrator/members/list-paginated.controller.ts
var list_paginated_controller_exports = {};
__export(list_paginated_controller_exports, {
  default: () => ListPaginatedController
});
module.exports = __toCommonJS(list_paginated_controller_exports);
...
var ListPaginatedSchema = import_zod2.default.object({
  page: import_zod2.default.coerce.number().default(1),
  perPage: import_zod2.default.coerce.number().default(50),
  search: import_zod2.default.string().trim().optional()
});

// app/controllers/administrator/members/list-paginated.controller.ts
var import_fastify_decorators2 = require("fastify-decorators");
var ListPaginatedController = class {
...
], ListPaginatedController.prototype, "handle", 1);
ListPaginatedController = __decorateClass([
  (0, import_fastify_decorators2.Controller)({
    route: "/administrator/members"
  })
], ListPaginatedController);
